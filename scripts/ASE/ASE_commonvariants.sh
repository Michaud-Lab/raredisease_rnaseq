...
VCF_DIR="/home/renaut/scratch/raredisease_rnaseq/ASE_commonvariants/vcf/"
ASE_DIR="/home/renaut/scratch/raredisease_rnaseq/ASE_commonvariants/"
...
gatk IndexFeatureFile -I ${VCF_DIR}/biallelic_common_variants.vcf.gz --verbosity ERROR
...
-V ${VCF_DIR}biallelic_common_variants.vcf.gz \
...
# STEP 7:  Deseq2
###########################
Rscript ./ASE.R ${ASE_DIR}/overlaps.tsv ${VCF_DIR}/biallelic_common_variants.vcf.gz  ${INPUT_DIR}/high_confidence_imprinted_genes.csv
