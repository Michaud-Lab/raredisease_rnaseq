# =============================================================================
# lr_quant.R - Long-read FRASER splicing analysis for candidate genes
# =============================================================================
...
if(file.exists(file.path(params$workdir,'../raredisease_rnaseq/data/candidate_genes_LR.csv')) !=TRUE) {
  ...
  write.csv(candidates_LR,file.path(params$workdir,'../data/candidate_genes_LR.csv'),row.names = FALSE, quote = TRUE)
} else candidates_LR = read.csv(file.path(params$workdir,'../data/candidate_genes_LR.csv'), header = TRUE)
...
bams_in =  data.frame(bams_in = list.files("/home/renaut/scratch/raredisease_rnaseq/results_06_01_2026/star_salmon/long_read/", pattern = 'bam$',recursive = FALSE, full.names = TRUE))
