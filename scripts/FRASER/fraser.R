...
command = paste('./fraser.sh', chr, start, stop, geneID)
...
#probands only
probands = c(1:nrow(sampleTable))[grepl('_03_',sampleTable$bamFile) | grepl('LC_',sampleTable$bamFile)| grepl('F0',sampleTable$bamFile)]
